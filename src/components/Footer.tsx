        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              ...
              {youtube && (
                <a href={youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="rounded-lg bg-primary-800 p-2 hover:bg-primary-700 transition-colors">
