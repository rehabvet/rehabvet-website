...
const STATIC_SERVICES: Record<string, { title: string; excerpt: string; body: string }> = {
  'veterinary-rehabilitation-consultation': {
    ...
    excerpt: 'Specialist advice and support to help animals recover from injury or illness.',
  ...
  'animal-rehabilitation': {
    ...
    excerpt: 'Restoring your pet to optimal physical and mental health through evidence-based interventions.',
  ...
  'dog-physiotherapy': {
    title: 'Physiotherapy',
    excerpt: 'Tailored treatments to help improve the mobility and wellbeing of dogs.',
  ...
  'dog-hydrotherapy': {
    title: 'Hydrotherapy',
    excerpt: 'A natural and holistic approach to improving the mobility and well-being of our canine companions.',
  ...
  'hbot-hyperbaric-oxygen-therapy-animals': {
    ...
    excerpt: 'Increased oxygen levels to improve your pet\'s overall health and wellbeing.',
  ...
  'traditional-chinese-veterinary-medicine': {
    ...
    excerpt: 'A holistic approach combining ancient Chinese wisdom with modern veterinary science.',
  ...
  'dog-chiropractic': {
    ...
    excerpt: 'A non-invasive and drug-free way to improve the well-being of our four-legged friends.',
  ...
  'dog-acupuncture': {
    title: 'Acupuncture',
    excerpt: 'Restoring the health, mobility, and quality of life of pets recovering from injury.',
...
export default async function ServicePage({ params }: Props) {
  ...
  /* If CMS has data, render rich version */
  if (service) {
    return (
      <>
