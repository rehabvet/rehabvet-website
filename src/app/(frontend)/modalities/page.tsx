          ...
          <div className="grid grid-cols-12 gap-6">
            {MODALITIES.map((mod, i) => {
              ...
              return (
                ...
                >
                  <div className={`${MODALITY_COLORS[i % MODALITY_COLORS.length]} p-5 lg:p-8 xl:p-10 rounded-2xl space-y-4 h-full flex flex-col hover:shadow-lg transition-shadow duration-300`}>
